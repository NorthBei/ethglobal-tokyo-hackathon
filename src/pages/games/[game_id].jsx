import { Col, Row, Typography, InputNumber, Button, Modal, Divider } from 'antd'
...
const GameItems = () => {
        ...
        <Col span={24}>
          <Row justify={'center'}>
            <div className={styles["item-img-wrapper"]}>
              <Image src={gamesImg} alt="game" className="item-img" width={300} height={300}  />
            </div>
          </Row>
        </Col>
        <Col span={24}>Korem ipsum dolor sit</Col>
        <Col span={24}>Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit Korem ipsum dolor sit </Col>
        <Col span={24}>$50.00</Col>
        <Col span={24}>
          <Row>
            <Col span={12}>
              <Row justify={'center'}>
                ...
                <InputNumber min={1} max={10} value={amount} onChange={setAmount} />
                <Button
                  type="primary"
                  onClick={() => {
            ...
            <Col span={12}><Button size='large' onClick={showModal} block>Draw</Button></Col>
          </Row>
        </Col>
      </>
    )
        ...
        {data.map((pack, i) => (
          <Col span={24} className="item-block" key={i}>
            <Row gutter={[20, 12]} justify="space-between" align="middle">
              <Col span={12}>
                <div className={styles["item-img-wrapper"]}>
                  <Image src={gamesImg} width={150} height={150} alt="item" className="item-img" />
                </div>
              </Col>
              <Col span={12}>
                <Row>
  ...
  const ConfirmModal = ({ open, onOk, onCancel }) => {
    return (
      <Modal footer={null} title="Draw" open={open}>
        ...
        <Row justify={'center'} gutter={12}>
          ...
          <Col span={10}>
            <Button type={'primary'} onClick={onOk} block>Confirm</Button>
          </Col>
        </Row>
      </Modal>
    )
    ...
    <>
      <section className="account">
        <div className="content">
          ...
          <ConfirmModal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} />
        </div>
      </section>
    </>
  )
